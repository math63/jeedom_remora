...
sendVarToJS('eqType', 'remora');
$eqLogics = eqLogic::byType('remora');
...
<div class="row row-overflow">
 ...
 <div class="eqLogicThumbnailContainer">
   ...
   <span style="font-size : 1.1em;position:relative; top : 23px;word-break: break-all;white-space: pre-wrap;word-wrap: break-word;color:#767676"><center>{{Configuration}}</center></span>
    ...
    <legend><i class="fas fa-table"></i>  {{Mes remora}}
    </legend>
    <div class="eqLogicThumbnailContainer">
      ...
      foreach ($eqLogics as $eqLogic) {
        ...
        log::add('remora', 'debug', 'test ' . $test);
        if (in_array($test, $files)) {
          $path = 'node_' . $eqLogic->getConfiguration('icone');
        } else {
          $path = 'remora_icon';
        }
        echo '<img src="plugins/remora/doc/images/' . $path . '.png" height="105" width="95" />';
        echo "</center>";
        ...
        <form class="form-horizontal">
          <fieldset>
            <div class="form-group">
              <label class="col-sm-3 control-label">{{Nom de l'équipement remora}}</label>
              <div class="col-sm-3">
